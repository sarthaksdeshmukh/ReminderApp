...
class ReminderService {
    ...
    static func updateReminder(reminder: Reminder, editConfig: ReminderEditConfig) throws -> Bool {
        ...
        reminderToUpdate.isCompleted = editConfig.isCompleted ?? false
    ...
    static func getReminderBySearchTerm(_ searchTerm: String) -> NSFetchRequest<Reminder> {
    ...
    static func saveReminderToMyList(myList: MyList, reminderTitle: String) throws {
        let reminders = Reminder(context: viewContext)
        reminders.title = reminderTitle
        myList.addToReminders(reminders)
        try save()
    }
